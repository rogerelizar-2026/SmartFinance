...
// ===== CORREÇÃO v1.0.2: Função robusta para download em todos os dispositivos =====
...
// ===== CORREÇÃO v1.0.2: Função para ler datas corretamente =====
...
// ===== CORREÇÃO v1.0.2: GRÁFICO WATERFALL (usa self em vez de smartfinance) =====
...
label += self.formatCurrency(value);
return label;
}
}
}
...
// ===== CORREÇÃO v1.0.2: payInvoice agora desconta da conta corrente =====
...
// ===== CORREÇÃO v1.0.2: handleCsvFileSelect limpo =====
...
document.addEventListener('DOMContentLoaded', () => {
const alertBtnTaskbar = document.getElementById('alertBtnTaskbar');
...
if (privacyBtnTaskbar) {
privacyBtnTaskbar.addEventListener('click', () => togglePrivacy());
}
if (themeBtnTaskbar) {
themeBtnTaskbar.addEventListener('click', () => toggleTheme());
}
if (menuBtnTaskbar) {
